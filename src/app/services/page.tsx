...
const SERVICES = [
  {
    ...
    desc: "Fast and reliable air freight for time-sensitive shipments. We handle general cargo with precision and speed, connecting major airports worldwide.",
    benefits: [
      "General cargo handling",
      "Express air shipments",
      "Air-to-Air transshipments",
      "Sea-to-Air transshipments",
